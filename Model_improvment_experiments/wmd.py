...
hw_comments = open('all_sent_HWest_2.txt', 'r', encoding='unicode-escape').readlines()
...
for comment in hw_comments:
    ...
    for single_comment in comments:
        ...
        if single_comment==b'"\\n':
            ...
            print(single_comment.encode('unicode-escape'))
...
print('Done.')
pdf.output('beautified_all_responses_added_keyword_check2.pdf', 'F')
